...
com1 = str('/usr/bin/hashcat -m 2500 ')
def option1():
	global pcap
	global hccap
	chunk()
	...
	if choice1 == '1':
		...
		mycommand=str('/usr/bin/cap2hccapx.bin ' + str(pcap) + ' ' + str(hccap))
...
# Label Cap File
labelCap = tk.Label(text="Cap File From")
...
# Label Hccap File
labelHccap = tk.Label(text="Hccap File To")
...
def convert2hccap():
	...
	mycommand='/usr/bin/cap2hccapx.bin ' + str(pcap) + ' ' + str(hccap)
...
# ----------------------------------------------------------------------
# Label Section 2
labelHack = tk.Label(text="Crack a hccap with Hashcat")
labelHack.grid(column=0, row=3, sticky="W", columnspan = 4)

# Label Hccap File
labelHccap2 = tk.Label(text="Hccap File From")
...
labelDictionary = tk.Label(text="Dictionary File From")
